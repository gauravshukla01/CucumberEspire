...
public class ExcelReader {
    ...
    public static void main(String[] args) {
        String filePath = System.getProperty("user.dir")+ System.getProperty("file.separator")+ "src\\test\\resources\\Excel_Data\\PdfComparatorData.xlsx";
        String sheetName = "Sheet1";
        String reportFilePath = System.getProperty("user.dir")+ System.getProperty("file.separator") + "src\\test\\resources\\PdfComparisionReport\\PDF_report"+TIME_STAMP+".csv";

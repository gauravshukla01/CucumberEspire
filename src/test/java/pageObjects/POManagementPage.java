...
public class POManagementPage {
	...
	public void uploadPOD () throws InterruptedException {
	       ...
	       int rowNum1 = ba.getMatchRowNum("//*[@role='table']/tbody/tr", "UT01439-001", 2, "getRowNum");
	...
	public void validateReciept () throws InterruptedException {
	       ...
	       ba.handleWebTable("//*[@role='table']/tbody/tr", "UT01439-001", 2, "clickItem");  // hard coded value
	       
	       // click the receipt action
	       ba.handleWebTable("//*[@role='table']/tbody/tr", "UT01439-001", 14, "clickItem");  // hard coded value

...
public class JiraClient {
    ...
    private static final String JIRA_API_TOKEN = "ATATT3xFfGF0cDoHBtxh07q7BVk6Eg-CBMQHBJA5tbqXSPvNXGcl0Br9PvAwNBmnq2qJ_iZyivqUicDgtW1OzOBML7n8aFppC2z_EWHayNsECoR9eXDpsGMVUqJOC9ZbPNJifIzHJrQBaKdnfY33RtpZPJFm21uIrrPmULbPnPe5t4_OGbcnlrA=3A925583";
    private static final String AUTH = "Basic " + Base64.getEncoder().encodeToString((JIRA_USERNAME + ":" + JIRA_API_TOKEN).getBytes());
